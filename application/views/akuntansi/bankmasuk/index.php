                ...
                <div class="col col-lg-12">
                    <div class="card">
                        <div class="card-header bg-gradient-light">
                            <div>
                                <h4 class="card-title">
                                    <a href="#" class="text-reset" id="btn-simpan-bankmasuk" data-aksi="tambah" data-status="<?= $status; ?>" tabindex="6"><i class="fas fa-save" style="color: teal"></i> Simpan Transaksi</a>
                                </h4>
                            </div>

                            <div class="float-right">
                                <h4 class="card-title" disabled="disabled">
                                    <a href="" class="text-reset" id="btn-tambah-rincianbankmasuk" data-status="<?= $status; ?>" tabindex="7">Tambah Rincian <i class="fas fa-file-alt" style="color: teal"></i></a>
                                </h4>
                            </div>
                        </div>
                        <!-- /.card-header -->
