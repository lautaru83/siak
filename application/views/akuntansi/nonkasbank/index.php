                            ...
                            <div class="float-right">
                                ...
                                ?>
                                        <h4 class="card-title" disabled="disabled">
                                            <a href="" class="text-reset" id="btn-selesai-nonkasbank" data-id="<?= $tran_id; ?>" data-total="<?= rupiah($totaldebet); ?>" data-status="<?= $status; ?>" tabindex="9">Selesai <i class="far fa-check-square" style="color: teal"></i></a>
                                        </h4>
                                <?php
                                    }
                                }
                ...
                <div class="col col-lg-12">
                    <div class="card">
                        <div class="card-header bg-gradient-light">
                            <div>
                                <h4 class="card-title">
                                    <a href="#" class="text-reset" id="btn-simpan-nonkasbank" data-aksi="tambah" data-status="<?= $status; ?>" tabindex="5"><i class="fas fa-save" style="color: teal"></i> Simpan Transaksi</a>
                                </h4>
                            </div>

                            <div class="float-right">
                                <h4 class="card-title" disabled="disabled">
                                    <a href="" class="text-reset" id="btn-tambah-rinciannonkasbank" data-status="<?= $status; ?>" tabindex="6">Tambah Rincian <i class="fas fa-file-alt" style="color: teal"></i></a>
                                </h4>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="" class="btn-edit-detailnonkasbank" data-id="<?= $idDetail; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-edit" style="color: olive"></i></a> - <a href="" class="btn-hapus-detailnonkasbank" data-id="<?= $idDetail; ?>" data-info="<?= $dataDetail['level6']; ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus"> <i class="far fa-trash-alt" style="color: maroon"></i></a>
                                                </td>
                                            </tr>
