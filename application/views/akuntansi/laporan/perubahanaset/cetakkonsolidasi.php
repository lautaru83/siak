    ...
    <table class="tabel-laporan">
        ...
        ?>
                <tr>
                    ...
                    <td align="right"><?= rupiah_positif($jumlahPttb); ?></td>
                </tr>
        <?php
            endforeach;
        }
        ...
        <tr>
            ...
            <td align="right" style="border-bottom:solid 1px;">
                <strong>
                    <?php
                    $idakun3 = "313";
                    $saldoAsetMutasi = saldoAkun6Laporan($akhir_periode, $idakun3);
        ...
        <tr>
            ...
            <td align="right" style="border-bottom:solid 1px;">
                <?php
                $idakun2 = "310";
                $saldoAsetAwalTahun = saldoAwalAbttKonsolidasi($idakun2, $pembukuan_id);
        ...
        <tr>
            ...
            <td align="right" style="border-bottom:solid 0.65mm;">
                <strong>
                    <?php
                    $asetAkhirTahun = $hasilSetelahPajak + $saldoAsetAwalTahun;
