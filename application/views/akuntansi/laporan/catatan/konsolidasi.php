                                    ...
                                    <div class="border-top my-1"></div> -->
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    <?php
                                                    $akun6 = $this->Laporan_model->calkAkun6Konsolidasi($idCatatan);
                                                    if ($akun6) {
                                                        $debet6 = 0;
                                                        $kredit6 = 0;
                                                        $jumlah6 = 0;
                                            ...
                                            $totalAb = 0;
                                            if ($calkAb) {
                                                $jumlahAbttKon = asetbersihTbKonsolidasi($awalbuku, $tanggal, $pembukuan_id);
                                                foreach ($calkAb as $dataCalkAb) :
                                                    ...
                                                    $jumlahAb = $kreditAb + $jumlahAbttKon - $debetAb;
                                                    //     if ($idCatatanAb == "310") {
                                                    // } else {
                                            ...
                                            ?>
                                                    ...
                                                    $kredit = 0;
                                                    $jumlah = 0;
                                                    $akun6Ab = $this->Laporan_model->calkAkun6AbKonsolidasi($idCatatanAb);
                                                    $total6Ab = 0;
                                                    if ($akun6Ab) {
                                                        foreach ($akun6Ab as $dataAkun6Ab) :
                                                            ...
                                                            if ($posisi == "S") {
                                                                $jumlah = $kredit + $jumlahAbttKon - $debet;
                                                            } else {
                                                                $jumlah = $kredit - $debet;
                                                            }
                                            ...
                                            ?>
                                                    ...
                                                    <?php
                                                    $akun6 = $this->Laporan_model->calkAkun6Konsolidasi($idCatatanPd);
                                                    $debet6 = 0;
                                                    $kredit6 = 0;
                                                    $jumlah6 = 0;
                                                    $total6Pd = 0;
