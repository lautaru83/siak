...
<body>
    ...
    <div class="judul-laporan">
        ...
        <br>
        <strong>CATATAN ATAS LAPORAN KEUANGAN KONSOLIDASI</strong>
        <br>
        <span>
    ...
    <table class="tabel-laporan">
        ...
        ?>
                ...
                <?php
                // $akun6 = $this->Laporan_model->calkAkun6Konsolidasi($idCatatanAK);
                $akun6 = $this->Laporan_model->calkAkun6KonsolidasiCetak($idCatatanAK);
                $debet6 = 0;
                $kredit6 = 0;
                $jumlah6 = 0;
                $total6 = 0;
