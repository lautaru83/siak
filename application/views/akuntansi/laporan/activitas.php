                            ...
                            <form>
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <select id="ak_pembukuan_id" name="ak_pembukuan_id" class="form-control">
                                            <?php
                                    ...
                                    <div class="col-md-2 mt-auto">
                                        ...
                                        <button type="submit" id="btn-tampil-activitas" data-id="<?= $institusi_id; ?>" data-tgl1="<?= $buku_awal; ?>" data-tgl2="<?= $buku_akhir; ?>" data-laporan="activitas" class="btn btn-primary">Tampilkan</button>
                                    </div>
                                </div>
                            </form>
                        </div>
