                    ...
                    <table id="tabel3" class="table table-sm table-borderless table-hover">
                        ...
                        <tbody>
                            ...
                            if ($bersihTidakTerikat) {
                                $jumlahAbttA = asetbersihTbKomKonsolidasi($buku_awalA, $tanggal, $pembukuan);
                                $jumlahAbttB = asetbersihTbKomKonsolidasi($buku_awalB, $tanggallalu, $tahunlalu);
