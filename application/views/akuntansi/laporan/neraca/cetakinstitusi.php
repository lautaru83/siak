    ...
    <table class="tabel-laporan">
        ...
        ?>
                <tr>
                    ...
                    <td width="18%" align="center"><?= $dataAsetLancar['catatan_id']; ?></td>
        ...
        ?>
                <tr>
                    ...
                    <td width="18%" align="center"><?= $dataAsetTidakLancar['catatan_id']; ?></td>
                    <td width="18%" align="right"><?= rupiah_positif($jumlahAsetTidakLancar); ?></td>
                </tr>
        <?php
            endforeach;
        }
        ...
        ?>
                <tr>
                    ...
                    <td width="18%" align="center"><?= $dataKewajiban['catatan_id']; ?></td>
                    <td width="18%" align="right"><?= rupiah_positif($jumlahKewajiban); ?></td>
                </tr>
        <?php
            endforeach;
        }
        ...
        if ($bersihTidakTerikat) {
            $jumlahAbtt = asetbersihTb($akhir_periode);
