...
<div class="content-wrapper">
    ...
    <section class="content">
                        ...
                        <div class="card-header bg-gradient-light">
                            ...
                            <div class="float-right">
                                <h4 class="card-title" disabled="disabled">
                                    <a href="<?= site_url('akademik/periodeakademik/cetak') ?>" target="_blank" class="text-reset">Cetak <i class="fas fa-print" style="color: teal"></i></a>
                                </h4>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?= $idPeriode; ?></td>
                                                <td><?= $dataPeriodeakademik['tahunakademik']; ?></td>
                                                <td><?= $dataPeriodeakademik['semester']; ?></td>
        ...
        <!-- /.container-fluid -->
        <?php $this->load->view('akademik/periodeakademik/modal');
        ?>
    </section>
    <!-- /.content -->
</div>
