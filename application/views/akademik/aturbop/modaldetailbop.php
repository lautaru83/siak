<!-- Modal Komponen BOP -->
<div class="modal fade" id="modal-detailaturbop" tabindex="-1">
    <div class="vertical-alignment-helper">
        <div class="modal-dialog modal-dialog-default">
            <div class="modal-content card">
                ...
                <form id="form-detailaturbop" class="form-horizontal">
                    ...
                    <div class="modal-footer card-footer">
                        <div>
                            <button id="btn-ubah-detailaturbop" type="submit" class="btn btn-primary"><i class="far fa-edit"></i> Ubah</button>
                        </div>
                        <div>
                            <button id="btn-simpan-detailaturbop" type="submit" class="btn btn-success"><i class="far fa-check-square"></i> Simpan</button>
                        </div>
                    </div>
                </form>
            </div>
