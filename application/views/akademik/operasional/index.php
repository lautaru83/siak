                    ...
                    <div class="card">
                        <div class="card-header bg-gradient-light">
                            ...
                            <!-- <div class="float-right">
                                <h4 class="card-title">
                                    <a href="" class="text-reset" id="btn-tutup-operasional" data-status="" tabindex="7">Tutup <i class="fas fa-window-close" style="color: maroon"></i></a>
                                </h4>
                            </div> -->
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col col-sm-1">
                                    <table class="table table-borderless table-sm">
                                        <tr>
                                            <td><a href="" class="text-reset" id="btn-tutup-operasional" data-status="" tabindex="7"><i class="fas fa-window-close" style="color: maroon"></i></a></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
