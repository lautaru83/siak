...
class Tahunajaranaktif extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model(array('akademik/Tahunajaran_model' => 'Tahunajaran_model', 'akademik/Tahunajaranaktif_model' => 'Tahunajaranaktif_model'));
    }
    public function index()
    {
        //echo "Angkatan";
        $data['kontenmenu'] = "Pengaturan";
        $data['kontensubmenu'] = "Tahun Ajaran Aktif";
        $data['tahunajaran'] = $this->Tahunajaran_model->ambil_data();
        $this->template->display('akademik/tahunajaranaktif/index', $data);
    }
