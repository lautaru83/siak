...
class Kewajiban extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model(array('operasional/Kewajiban_model' => 'Kewajiban_model', 'akademik/Tahunajaranaktif_model' => 'Tahunajaranaktif_model', 'akuntansi/Kodeperkiraan_model' => 'Kodeperkiraan_model'));
    }
    public function index()
    {
        ...
        $data['kewajiban'] = $this->Kewajiban_model->ambil_data();
        $this->template->display('operasional/kewajiban/index', $data);
    }
